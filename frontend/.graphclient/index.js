...
const importedModule$0 = tslib_1.__importStar(require("./sources/analytics/introspectionSchema.json"));
...
const importFn = (moduleId) => {
    ...
    switch (relativeModuleId) {
        case ".graphclient/sources/analytics/introspectionSchema.json":
...
async function getMeshOptions() {
    ...
    const analyticsHandler = new graphql_1.default({
        name: "analytics",
        config: { "endpoint": "https://ethereum-mainnet.graph-eu.p2pify.com/7bb8d3da3bc6edccafcee65a672ab943/analytics" },
        baseDir,
        cache,
        pubsub,
